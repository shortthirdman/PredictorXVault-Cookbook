...
[![Made withJupyter](https://img.shields.io/badge/Made%20with-Jupyter-orange?style=for-the-badge&logo=Jupyter)](https://jupyter.org/try)	![GitHub License](https://img.shields.io/github/license/shortthirdman/PredictorXVault-Cookbook?style=for-the-badge)	[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/shortthirdman/PredictorXVault-Cookbook/main)	![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/shortthirdman/PredictorXVault-Cookbook?style=for-the-badge)	<!-- notebook-badge-start --> ![Static Badge](https://img.shields.io/badge/Jupyter_Notebooks_Python3-25-brightgreen?style=for-the-badge<!-- notebook-badge-start --> ![Static Badge](https://img.shields.io/badge/Jupyter_Notebooks_Python3-25-brightgreen?style=for-the-badge<!-- notebook-badge-start --> <!-- notebook-badge-end -->logo=jupyter<!-- notebook-badge-start --> <!-- notebook-badge-end -->logoSize=auto<!-- notebook-badge-start --> <!-- notebook-badge-end -->label=Jupyter%20Notebooks%20(Python3)) <!-- notebook-badge-end -->logo=jupyter<!-- notebook-badge-start --> ![Static Badge](https://img.shields.io/badge/Jupyter_Notebooks_Python3-25-brightgreen?style=for-the-badge<!-- notebook-badge-start --> <!-- notebook-badge-end -->logo=jupyter<!-- notebook-badge-start --> <!-- notebook-badge-end -->logoSize=auto<!-- notebook-badge-start --> <!-- notebook-badge-end -->label=Jupyter%20Notebooks%20(Python3)) <!-- notebook-badge-end -->logoSize=auto<!-- notebook-badge-start --> ![Static Badge](https://img.shields.io/badge/Jupyter_Notebooks_Python3-25-brightgreen?style=for-the-badge<!-- notebook-badge-start --> <!-- notebook-badge-end -->logo=jupyter<!-- notebook-badge-start --> <!-- notebook-badge-end -->logoSize=auto<!-- notebook-badge-start --> <!-- notebook-badge-end -->label=Jupyter%20Notebooks%20(Python3)) <!-- notebook-badge-end -->label=Jupyter%20Notebooks%20(Python3)) <!-- notebook-badge-end -->	![GitHub repo size](https://img.shields.io/github/repo-size/shortthirdman/PredictorXVault-Cookbook?style=for-the-badge)
